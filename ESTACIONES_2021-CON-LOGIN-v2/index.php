<?php 
    ...
    include_once 'php/muetra_datos.php';
...
<main>  
    ...
    <section class="wrap">
        ...
        <a href="login_init.php" class="button-sesion">Iniciar sesion</a>
    </section>
